...
extern "C" {
    ...
    pub fn acl_get_permset_mask_np(entry_d: *mut _acl_entry, mask_p: *mut u64) -> i32;
    ...
    pub fn acl_set_permset_mask_np(entry_d: *mut _acl_entry, mask: u64) -> i32;
    ...
    pub fn acl_maximal_permset_mask_np(mask_p: *mut u64) -> i32;
    pub fn acl_to_text(acl: *mut _acl, len_p: *mut isize) -> *mut i8;
    ...
    pub fn acl_size(acl: *mut _acl) -> isize;
    ...
    pub fn acl_copy_ext(buf_p: *mut c_void, acl: *mut _acl, size: isize) -> isize;
    ...
    pub fn acl_copy_ext_native(buf_p: *mut c_void, acl: *mut _acl, size: isize) -> isize;
